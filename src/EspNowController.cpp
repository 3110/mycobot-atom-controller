...
EspNowController::EspNowController(const uint8_t channel) : ESP_NOW_BROADCAST_ADDRESS{
                                                                0xFF,
                                                                0xFF,
                                                                0xFF,
                                                                0xFF,
...
{
    return esp_now_send((uint8_t *)broadcastPeer.peer_addr, data, len);
}
...
void EspNowController::initPeer(const uint8_t *addr, esp_now_peer_info_t &peer)
{
